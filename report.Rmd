...
Additional field order data can be incorporated if available to update existing LSPEC records with new depth information.
...
if(exists("fieldorder_updated") && exists("fieldorder_processing_summary")) {
  ...
  if(input_records == output_records) {
    cat("Data structure maintained through update process.\n")
  }
  cat("\n")
} else {
